var runner,ground1,score,cloud,obstacle,gamestate,gameover,restart,cloud1,obstacle1,select;
var c,go,g2,o1,o2,o3,o4,o5,o6,r,running,colliding
function preload(){
...
running=loadAnimation("image1.jpg","image2.jpg","image3.jpg","image4.jpg","image5.jpg","image6.jpg","image7.jpg","image8.jpg");
 colliding=loadAnimation("image1.jpg") 
}
function setup(){
createCanvas(windowWidth,windowHeight)
  runner= createSprite(47,353);
runner.addAnimation("runner",running);
  runner.addAnimation("colliding",colliding);
...
if (touches.length>0||keyDown("up")&& runner.y>=300) {
runner.velocityY= -9;
touches=[];
...
runner.changeAnimation("colliding", colliding);
gamestate="end";
...
touches=[];
  gameover.visible= false;
restart.visible= false;
runner.changeAnimation("runner", running);
score=0;
}
